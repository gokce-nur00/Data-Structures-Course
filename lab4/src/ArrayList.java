...
public class ArrayList<E> implements List<E> {
  ...
  public ArrayListIterator listIterator(){
    ArrayListIterator arr=new ArrayListIterator();
    for (int i = 0; i < data.length; i++) {
      arr.add(ArrayList.this.get(i));
    }
    return arr;
  }
  public ArrayListIterator listIterator(int i){
    ArrayListIterator arr=new ArrayListIterator();
  ...
  public class ArrayListIterator implements ListIterator<E>{
    ArrayIterator temp=new ArrayIterator();
    @Override
    ...
    public E previous()throws NoSuchElementException {
      if (temp.j<=0) throw new NoSuchElementException("No next element");
      return get(temp.j-1);
    }
